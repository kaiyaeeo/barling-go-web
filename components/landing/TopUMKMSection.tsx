    ...
    import { ChevronLeft, ChevronRight, Star, ShoppingBag, ArrowRight, TrendingUp } from "lucide-react"
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            >
                ...
                return (
                    ...
                    className="group shrink-0 w-60 bg-white rounded-2xl overflow-hidden border border-gray-100 hover:border-[#6EB8BB]/30 hover:shadow-xl hover:-translate-y-1 transition-all duration-300"
                    ...
                    <div className="relative h-44 overflow-hidden bg-gray-100">
                        ...
                        {/* Rank badge */}
                        {idx < 3 && (
                        <div className="absolute top-3 left-3 w-7 h-7 rounded-xl flex items-center justify-center text-[11px] font-black text-white shadow-md"
            ...
            <Link
                href="/umkm"
                className="px-5 py-2.5 text-sm font-bold text-[#6EB8BB] border-2 border-[#6EB8BB]/30 rounded-xl hover:bg-[#E6F7F8] transition-all"
            >
                Jelajahi Semua UMKM
            </Link>
            <div className="flex gap-2">
                <button
                onClick={() => scroll("left")}
                className="w-10 h-10 rounded-full border-2 border-gray-200 flex items-center justify-center hover:border-[#6EB8BB] hover:text-[#6EB8BB] transition-all bg-white"
                >
                <ChevronLeft size={16} />
                </button>
                <button
